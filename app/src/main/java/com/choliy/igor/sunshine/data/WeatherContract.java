...
public final class WeatherContract {
     ...
     * Play Store.
     */
    public static final String CONTENT_AUTHORITY = "com.choliy.igor.sunshine";
     ...
     *
     *     content://com.choliy.igor.sunshine/weather/
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static Uri buildWeatherUriWithDate(long date) {
            ...
            Uri dateUri = CONTENT_URI.buildUpon()
                    .appendPath(Long.toString(date))
                    .build();

            Log.i(TAG, "Uri with date: " + dateUri.toString());
        ...
        public static String getSqlSelectForTodayOnwards() {
            long normalizedUtcNow = DateTimeUtils.normalizeDate(System.currentTimeMillis());
